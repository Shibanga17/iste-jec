...
import { 
  ...
  Mail, Calendar, MapPin, Clock, Camera, FolderGit2, Hammer, User, ArrowUpRight,
...
export default function Home() {
  ...
  // --- STATE FOR TEAM (Tap to reveal on mobile) ---
  ...
  // --- DATA ARRAYS ---
  const teamMembers = [
    { id: 1, name: "Shibanga Barman", designation: "Chairman", year: "4th Year", branch: "Computer Science & Engineering", image: "/shibanga.jpeg" },
    { id: 2, name: "Doly Barman", designation: "General Secretary", year: "4th Year", branch: "Mechanical Engineering", image: "/doly.png" },
    { id: 3, name: "Himashree Talukdar", designation: "Assistant General Secretary", year: "4th Year", branch: "Computer Science & Engineering", image: "/himashree.png" },
    { id: 4, name: "Udipta Kumar Sarma", designation: "Secretary", year: "4th Year", branch: "Mechanical Engineering", image: "/udipta.png" },
    { id: 5, name: "Bhubatswa Batshas Puzari", designation: "", year: "3rd Year", branch: "Civil Engineering", image: "/bhubatswa.png" },
    { id: 6, name: "Abhinav Neog", designation: "", year: "3rd Year", branch: "Computer Science and Engineering", image: "/abhinav.png" },
    { id: 7, name: "Deepshikha Gogoi", designation: "", year: "3rd Year", branch: "Branch Name Here", image: "/deepshikha.png" },
    { id: 8, name: "Ripanshi Kumari", designation: "", year: "3rd Year", branch: "Branch Name Here", image: "/ripanshi.jpeg" },
    { id: 9, name: "Dipshika Rai", designation: "", year: "3rd Year", branch: "Branch Name Here", image: "/dipshika_rai.png" }
  ];
  ...
  return (
    <main className="min-h-screen bg-[#040814] text-white relative">
      ...
      {/* SINGLE BACKGROUND INSTANCE FOR BETTER PERFORMANCE */}
      ...
      {/* ================= TEAM SECTION ================= */}
      <section id="team" className="relative z-10 py-24 px-6 max-w-6xl mx-auto border-t border-slate-800/50">
        <motion.div initial={{ opacity: 0, y: -20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="text-center max-w-3xl mx-auto mb-16">
           <h1 className="text-4xl md:text-6xl font-black tracking-tight mb-6">
            Core <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400">Team</span>
          </h1>
        </motion.div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-12">
          {teamMembers.map((member, index) => (
            <motion.div 
              key={member.id} 
              initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-50px" }} transition={{ duration: 0.5, delay: (index % 3) * 0.15 }} 
